...
const Lead = () => {
  ...
  return (
    <div>
      <LeadsForm open={open} setOpen={setOpen} setEditedLead={setEditedLead} editedLead={editedLead} />
      {/* <LeadCard />
      {loggedUser.isAdmin && <LeadTable open={open} setOpen={setOpen} setEditedLead={setEditedLead} />}
