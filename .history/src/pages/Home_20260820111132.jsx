...
import { employeeLineChart, employeeTaskOverviewChart } from '../component/EmployeeBaseDashboard/utils/EmployeeBaseData.jsx'
...
const Home = () => {
  ...
  const employeeLeadStatusCharts = employeeLeadChart(leads,current)
