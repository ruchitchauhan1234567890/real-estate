...
import { employeeLineChart } from '../component/EmployeeBaseDashboard/utils/EmployeeBaseData.jsx'
...
const Home = () => {
  ...
  const employeeLeadCharts = employeeLineChart(leads,selectedMonth)
  const leadStatusCharts = leadStatusChart(leads)
  const taskOverviewCharts = taskOverviewChart(task)
  
  // console.log(employeeLeadCharts)
