        ...
        !current.isAdmin && (
          <>
            ...
            <div className="grid grid-cols-6 gap-2 mt-2">
              <div className="bg-white rounded-xl border col-span-2 border-gray-200 shadow-sm h-full">
              ...
              <div className="bg-white rounded-xl border col-end-2 border-gray-200 shadow-sm h-full">
                <LeadStatusChart
