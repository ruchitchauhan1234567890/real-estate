...
const Lead = () => {
  ...
  return (
    <div>
      ...
      {/* { loggedUser.isAdmin && <LeadTable leadData={leadData} selectedEmp={selectedEmp} setSelected={setSelectedEmp} selectedLead={selectedLead} setSelectedLead={setSelectedLead} />} */}
