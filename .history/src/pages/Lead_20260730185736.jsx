...
const Lead = () => {
  ...
  return (
    <div>
      ...
      { loggedUser.isAdmin && leadData &&  <LeadTable leadData={leadData} selectedEmp={selectedEmp} setSelectedEmp={setSelectedEmp} selectedLead={selectedLead} setSelectedLead={setSelectedLead} />}
