...
const Task = () => {
  ...
  return (
    <div>
      <TaskForm open={open} setOpen={setOpen} editedTask={editedTask} setEditedTask={setEditedTask} />
      <TaskCard />
      {loggedUser.isAdmin && <TaskTable  open={open} setOpen={setOpen} editedTask={editedTask} setEditedTask={setEditedTask} />}
