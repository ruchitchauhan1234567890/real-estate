        ...
        !current.isAdmin && (
          <>
            ...
            <div className="grid grid-cols-6 gap-2 mt-2">
              ...
              {/* Lead Creation Chart */}
              <div className="bg-white col-span-4 rounded-xl border border-gray-200 shadow-sm">
                <LeadCreationChart
              ...
              {/* Task Overview */}
              <div className="bg-white col-span-2 rounded-xl border border-gray-200 shadow-sm">
                <TaskOverviewChart
            ...
            {/* Second Row */}
            <div className="grid grid-cols-6 gap-2 mt-2">
              <div className="  min-h-[220px] bg-white col-span-2 rounded-xl border border-gray-200 shadow-sm">
                <LeadStatusChart
                  data={employeeLeadStatusCharts}
                />
              </div>
              <div className="col-span-2">
                  <OverDueFollowUp data={myLead} />
              </div>

              <div className="col-span-2">
                <TodaysFollowUp data={myLead} />
              </div>
