...
const TopEmployee = ({ employee, lead }) => {
    ...
    const data = employee.map((emp) => {
        ...
        return {
            ...
            conversionRate:
                result.totalLead > 0
                    ? ((result.convertedLead / result.totalLead) * 100).toFixed(2)
                    : 0
        }
    })
    ...
    return (
        <div className="w-full h-full rounded-xl p-3 shadow-sm">
            ...
            <div className="mb-3 flex items-center justify-between">
                ...
                <button className="text-[12px] font-medium text-blue-600 hover:text-blue-700" onClick={() => setShowAll(!showAll)}>
