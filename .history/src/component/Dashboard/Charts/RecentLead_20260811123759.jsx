...
const RecentLead = ({ data }) => {
    ...
    return (
        <div className="w-full rounded-xl  p-5 shadow-sm border border-gray-100">
            ...
            <div className="space-y-2">
                {latest.map((item) => {
                    return (
                        <div
                            key={item._id}
                            className="flex items-center justify-between rounded-lg px-3 py-3 hover:bg-gray-50 transition"
                        >
