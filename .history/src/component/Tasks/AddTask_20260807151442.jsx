                    ...
                    <div className="grid grid-cols-3 gap-3 mt-4">
                        ...
                        <div className="flex flex-col">
                            ...
                            {inputData.relatedTask === "general" ?
                                <div className="w-full h-full mt-2 border rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                </div>
                                :
                                <Select
                                    options={options}
                        ...
                        <div className="flex flex-col">
                            ...
                            {inputData.relatedTask === "general"
                                ? <Select
                                    ...
                                    onChange={(select) => {
                                        setInputData((prev) => ({ ...prev, assign: select.value }))
                                    }}
                                    className="mt-2 border rounded"
                                /> :
