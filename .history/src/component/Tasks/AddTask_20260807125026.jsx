            ...
            <div className="bg-white w-full max-w-5xl rounded-lg shadow-xl">
                ...
                <form className="p-6" onSubmit={handleSubmit}>
                    <div className="border flex ">
                        <label className="pr-3">Related Task : </label>
                        <div className="flex justify-between bg-amber-400 w-20">
                        <input type="radio" name="relatedTask" value="Lead" className="border bg-amber-300" />Lead
                        <input type="radio" name="relatedTask" value="General" className=""/>General
                        </div>
                    </div>
