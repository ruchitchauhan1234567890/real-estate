...
const AddTask = ({ open, setOpen,taskData,setTaskData,editedTask,setEditedTask }) => {
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/40">
            <div className="bg-white w-full max-w-5xl rounded-lg shadow-xl">
                <div className="flex justify-between m-4">
                    ...
                    <button onClick={() =>{ setOpen(!open),setEditedTask(null) }}>
                        <IoClose size={28} />
                    </button>
                </div>
                <form className="p-6" onSubmit={handleSubmit}>
                    <div className="grid grid-cols-3 gap-3">
                        ...
                        <div className="flex flex-col">
                            ...
                            <select name="lead" value={inputData.lead} className="w-full mt-2 border rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="w-full mt-2 h-10 border rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                name="assign" value={selectEmployee.name ? "selectEmployee" : ""}>{selectEmployee.name ? selectEmployee.name : ""}</div>
                        </div>
                        ...
                        <div className="flex flex-col">
                            ...
                            <input value={inputData.date} onChange={handleChange} name="createdDate" className="w-full mt-2 border rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                type="date" />
                        </div>
                    </div>
                    <div className="flex justify-end gap-3 mt-8 border-t pt-5">
                        <button
                            type="button"
                            onClick={() => {setOpen(!open),setEditedTask(null)}}
