                        ...
                        return (
                            <tr>
                                ...
                                <td className="border p-1">
                                    <select className="w-full mt-2 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                        name="taskStatus" value={task.taskStatus} onChange={handleChange}>
                                        <option>Pending</option>
                                        <option>Completed</option>
                                        <option>Processing</option>
                                    </select>
