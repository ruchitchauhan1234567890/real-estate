            ...
            <div className="flex gap-2 mt-2">
                <div>
                    <input type="text"
                        ...
                        className="w-72 rounded-sm border border-gray-300 px-4 py-[10px] outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <button className="rounded-sm border border-gray-300 bg-gray-200 px-4 py-2 focus:ring-2 focus:ring-blue-500" onClick={() => setFilters({
                    taskStatus: "All",
                    priority: "All",
                    searchTask: ""
                })}>Reset Filter</button>
