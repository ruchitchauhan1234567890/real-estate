            ...
            <div className="bg-white w-full max-w-5xl rounded-lg shadow-xl">
                ...
                <form className="p-6" onSubmit={handleSubmit}>
                    <div>
                        ...
                        <input type="radio" name="relatedTask" value="Lead" className="border w-5 bg-amber-300" />Lead
                        <input type="radio" name="relatedTask" value="General" className="w-20"/>General
                    </div>
