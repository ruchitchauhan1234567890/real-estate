...
const TaskTable = () => {
    ...
    return (
        <div>
            ...
            <table className="min-w-full overflow-hidden rounded-xl border border-gray-200 mt-2">
                    ...
                    {filterData.map((task, index) => {
                        return (
                            <tr className="hover:bg-blue-50 transition duration-150">
                                <td className="px-5 py-2 text-sm text-gray-700">{index + 1}</td>
                                <td className="px-5 py-2 text-sm text-gray-700">{task.title}</td>
                                <td className="px-5 py-2 text-sm text-gray-700">{task.lead || " - "}</td>
                                <td className="px-5 py-2 text-sm text-gray-700">{task.assign}</td>
                                <td className="px-5 py-2 text-sm text-gray-700">{task.priority}</td>
                                <td className="px-5 py-2 text-sm text-gray-700">{task.taskStatus}</td>
