    ...
    return (
        <div>
            <div className="flex gap-2 mt-2">
                ...
                <div className="">
                    <select onChange={handleChange}className="rounded-lg border border-gray-300 px-4 py-2 focus:ring-2 focus:ring-blue-500" name="priority" value={filters.priority}>
                        <option>All</option>
                        <option>High</option>
                ...
                <div className="">
                    <select onChange={handleChange} className="rounded-lg border border-gray-300 px-4 py-2 focus:ring-2 focus:ring-blue-500" name="taskStatus" value={filters.taskStatus}>
                        <option>All</option>
                ...
                <button className="rounded-lg border border-gray-300 bg-gray-200 px-4 py-2 focus:ring-2 focus:ring-blue-500" onClick={() => setFilters({
                    taskStatus: "All",
                    priority: "All",
                    searchTask: ""
                })}>Reset Filter</button>
