                        ...
                        return (
                            <tr>
                                ...
                                <td className="border flex justify-center gap-3 py-1 px-1   ">
                                    <MdDeleteOutline onClick={() => handleDelete(task.id)} className="w-5  bg-gray-300 hover:bg-gray-400 rounded h-6 " />
                                    <HiPencilSquare onClick={() => handleUpdate(task)} className="w-5 bg-gray-300 hover:bg-gray-400 rounded  h-6" />
                                </td>
                            </tr>
                        )
                    })}
