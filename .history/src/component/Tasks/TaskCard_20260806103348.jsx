...
const TaskCard = () => {
    ...
    const myTask = taskData.filter((tasks) => tasks.assign === loggedUser.name)
    console.log(myTask)
    ...
    if (loggedUser.isAdmin) {
        ...
        pending = taskData.filter((task) => task.taskStatus === "Pending").length
        inProgress = taskData.filter((task) => task.taskStatus === "Processing").length
        completed = taskData.filter((task) => task.taskStatus === "Completed").length
    } else {
