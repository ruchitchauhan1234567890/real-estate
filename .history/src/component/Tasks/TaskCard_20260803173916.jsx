...
const TaskCard = () => {
    ...
    if (loggedUser.isAdmin) {
        ...
        const totalTask = myTask.length
        const pending = myTask.filter((task) => task.taskStatus === "Pending").length
        const inProgress = myTask.filter((task) => task.taskStatus === "Processing").length
        const completed = myTask.filter((task) => task.taskStatus === "Completed").length
    }
