            ...
            <div className="bg-white w-full max-w-5xl rounded-lg shadow-xl">
                ...
                <form className="p-6" onSubmit={handleSubmit}>
                    <div className="flex ">
                        ...
                        <input type="radio" checked={inputData.relatedTask === "lead"}  name="relatedTask" value="lead" />Lead
                        <input type="radio" checked={inputData.relatedTask === "general"}  name="relatedTask" value="general" />General
                        </div>
                    </div>
