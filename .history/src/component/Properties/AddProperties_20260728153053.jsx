            ...
            <div className="w-200 border p-4 rounded-md bg-white">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-3 gap-5">
                        ...
                        <div className="flex flex-col gap-2">
                            <label>Price</label>
                            <input type="number" name="price" onChange={handleChange} placeholder="Enter Price" className="border rounded p-2"/>
                        </div>
                        ...
                        <div className="flex flex-col gap-2">
                            <label>Image</label>
                            <input type="file" name="file" className="border rounded p-2" onChange={handleChange} />
                        </div>
