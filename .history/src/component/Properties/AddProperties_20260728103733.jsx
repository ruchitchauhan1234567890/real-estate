        ...
        <div className="w-full border-1 p-4">
            ...
            <form>
                <div className="grid grid-cols-3 mt-3 ">
                    ...
                    <div className="flex flex-col gap-1">
                        <label>Type</label>
                        <select name="type" id="type"  className="border-1 rounded-sm w-30">
                            <option>Villa</option>
                            <option>Flat</option>
                    ...
                    <div className="flex flex-col gap-1">
                        <label>Status :</label>
                        <select name="Status" id="Status" className="border-1 rounded-sm w-30">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <input type="file" className="border-1 w-30" />
                    </div>
                </div>
            </form>
        </div>
