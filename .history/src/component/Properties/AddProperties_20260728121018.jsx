        ...
        <div className="w-full border-1 p-4">
            ...
            <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-3 mt-5 ">
                    ...
                    <div className="flex flex-col gap-1">
                        <label>Type :</label>
                        <select name="type" id="type" value={inputData.type} onChange={handleChange} className="border-1 rounded-sm w-50">
                    ...
                    <div className="flex flex-col">
                        ...
                        <textarea name="location" value={inputData} onChange={handleChange} className="border-1  rounded-sm"></textarea>
                    </div>
