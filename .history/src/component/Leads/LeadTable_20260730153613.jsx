...
const LeadTable = ({ leadData, selectedLead, setSelectedLead, selectedEmp, setSelectedEmp }) => {
  ...
  return (
    <div>
      <div>
        <label className="border-2 h-10 w-">
          <IoSearchSharp />
          <input type="text" placeholder='search lead' className=" bg-[url(C:\Users\Admin\Downloads\magnifying-glass-icon-isolated-on-white-background-search-illustration-vector.jpg)]" />
        </label>
      </div>
