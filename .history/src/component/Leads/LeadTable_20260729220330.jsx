...
const LeadTable = ({ leadData, selectedLead, setSelectedLead }) => {
      ...
      <table className="w-full border-collapse border-2  mt-4">
        ...
        <tbody>
          {leads.map((curr, index) => {
            return (
              <tr>
                <td className="border items-center px-auto bg-amber-600"><input type="checkbox" onChange={(e) => handleCheck(e, index)} className="border-2" /></td>
