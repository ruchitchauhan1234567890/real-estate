...
const AddLead = ({ open, setOpen, setEditedLead, editedLead }) => {
    ...
    const handleSubmit = (e) => {
        ...
        e.preventDefault()
        if (editedLead) {
            const findLead = leads.filter((lead) => {
                if (lead.id === editedLead.id) {
                    return inputData
                }
                return lead
            })
            localStorage.setItem("leads", findLead)
            setInputData({
                name: "",
                phone: "",
                email: "",
                ...
                <form className="p-6" onSubmit={handleSubmit}>
                    <div className="grid grid-cols-3 gap-3">
                        ...
                        <div className="flex flex-col">
                            ...
                            <select onChange={handleChange} value={inputData.source} className="w-full mt-2 border rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" name="source">
                        ...
                        <div className="flex flex-col">
                            ...
                            <select onChange={handleChange} value={inputData.status} className="w-full mt-2 border rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" name="status">
                                <option>New</option>
