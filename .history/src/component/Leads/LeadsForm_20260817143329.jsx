...
const LeadsForm = ({open,setOpen,setEditedLead ,editedLead}) => {
  ...
  return (
    <div className="flex justify-between items-center shadow-sm h-12 px-2">
      ...
      <div>
        ...
        <button className="px-2 py-1 m-2 rounded-sm border shadow-sm" onClick={handleImport}>Import</button>
      ...
      {loggedUser.isAdmin && open && <AddLead open={open} setOpen={setOpen} setEditedLead={setEditedLead} editedLead={editedLead} />}
