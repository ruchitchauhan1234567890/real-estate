...
const LeadsForm = ({ leadData, setLeadData, selectedLead ,selectedEmp,setSelectedEmp }) => {
  ...
  return (
    <div className="flex justify-between items-center shadow-sm h-12 px-2">
      ...
      {openModel && <AssignedModel openModel={openModel} selectedEmp={selectedEmp} setSelectedEmp={setSelectedEmp}  setOpenModel={setOpenModel} item={item}/>}
    </div>
  )
}
