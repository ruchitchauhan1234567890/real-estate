...
const AssignedModel = ({ openModel, setOpenModel, selectedLead, setSelectedLead, item, selectedEmp, setSelectedEmp }) => {
    ...
    return (
        <div className="h-100 w-200 shadow-sm border-1 rounded-sm p-2 items-center m-auto bg-white center z-50 inset-0 fixed">
