                        ...
                        return (
                            <tr>
                                ...
                                <td className="border p-1">
                                    <select className="" value={curr.status} name="status" onChange={() => handleStatusChange()}>
                                        {/* <option value="status" disabled selected>Status</option> */}
                                        <option>New</option>
                                        <option>Connected</option>
                                        <option>Qualified</option>
                                ...
                                <td className="border p-1">
                                    <input type="date" name="nextFollowUpdate" value={curr.next} onChange={(e) => handleDateChange(e, curr.id)} />
