      ...
      <table className="w-full border-collapse border-2  mt-2">
        ...
        <tbody>
          {filterData ? filterData.map((curr, index) => {
            return (
              <tr>
                <td className="border items-center pl-7"><input ref={checkRef} type="checkbox" checked={selectedLead.includes(curr.id)} onChange={(e) => handleCheck(e, curr.id)} className="border-2" /></td>
