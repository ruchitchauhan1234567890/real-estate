            ...
            return (
              <tr>
                ...
                <td className="border flex justify-between py-1 px-3">
                  <MdDeleteOutline onClick={() => handleDelete(curr.id)} className="w-5 bg-gray-300 hover:bg-gray-400 rounded h-6 " />
                  <HiPencilSquare onClick={() => handleUpdate(curr)} className="w-5 bg-gray-300 hover:bg-gray-400  rounded  h-6" />
                </td>
              </tr>
            )
          }) : ""}
