...
const UserLeadTable = () => {
    ...
    const filterLead = userLead.filter((lead) => {
        ...
        const todayFollowUp = filters.todayFollowUp == "" ||  lead.nextFollowUpDate === today

        return (status && leadSearch && todayFollowUp)
    })
    ...
    return (
        <div className="mt-2">
            <div className="my-1 flex gap-2">
                ...
                <div className="p-1 border rounded">
                    <select name="todayFollowUp" onChange={handleChange}>
                        <option>All</option>
