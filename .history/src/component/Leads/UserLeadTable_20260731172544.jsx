...
const UserLeadTable = () => {
    ...
    return (
        <div className="mt-2">
            <div className="my-1">
                <div className="">
                    <input type="text" placeholder="search lead" className="border" />
                </div>
                <div>
                    <select  className="w-full mt-2 border rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" name="status">
                        <option>New</option>
