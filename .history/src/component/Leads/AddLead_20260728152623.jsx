                ...
                <form className="p-6">
                    <div className="grid grid-cols-3 gap-3">
                        ...
                        <div className="flex flex-col">
                            ...
                            <select className="w-full mt-2 border rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" name="source">
                        ...
                        <div className="flex flex-col">
                            ...
                            <select className="w-full mt-2 border rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" name="assignedTo">
                    ...
                    <div>
                        <button type="submit" className="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Add Lead</button>
                    </div>
                </form>
            </div>
        </div>
