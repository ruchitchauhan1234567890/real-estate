...
const LeadCard = () => {
    ...
    if (loggedUser.isAdmin) {
        ...
        const connected = myLead.filter((curr, index) => curr.status === "Connected").length
        const qualified = myLead.filter((curr, index) => curr.status === "Qualified").length
        const converted = myLead.filter((curr, index) => curr.status === "Converted").length
        const lost = myLead.filter((curr, index) => curr.status === "Lost").length
        const newLead = myLead.filter((curr, index) => curr.status === "New").length
    }
