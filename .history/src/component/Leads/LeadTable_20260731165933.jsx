  ...
  return (
    <div>
      <div className="flex gap-2">
        <div className="mt-2">
          <input type="text" onChange={handleChange} placeholder='search lead' className="border rounded p-1" />
        </div>
        <form className="flex gap-2">
          ...
          <div className=" mt-2 bg-gray-300 border rounded items-center px-2">
