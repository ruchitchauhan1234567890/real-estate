                ...
                <form className="p-6" onSubmit={handleSubmit}>
                    ...
                    <div className="grid grid-cols-4 gap-5">
                        ...
                        <div>
                            ...
                            <select value={inputData.department} className="w-full mt-2 border rounded-md px-4 py-2" name="department" onChange={handleChange}>
                                <option>Sales</option>
                        ...
                        <div>
                            ...
                            <select value={inputData.role} className="w-full mt-2 border rounded-md px-4 py-2" name="role" onChange={handleChange}>
                        ...
                        <div>
                            ...
                            <select value={inputData.status} value={inputData.status} className="w-full mt-2 border rounded-md px-4 py-2" name="status" onChange={handleChange}>
