    ...
    return (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
            <div className=" w-150 h-100 bg-white shadow rounded p-4" >
                ...
                <div>
                    <p className="font-red">{`This employee has ${findLeads.length} assigned leads. Please reassign those leads to another employee before deleting this employee.`}</p>
                </div>
                <hr/>
            </div>
        </div>
