...
const EmployeeCard = ({ data, setData }) => {
    ...
    console.log(data)
    return (
        <div className="grid grid-cols-3 gap-3 mt-4 m-auto content-baseline place-items-center">
            {cards.map((data,index) => {
                return (
                    <div key={index} className="w-70 h-17 shadow-2xl rounded-sm flex items-center">
