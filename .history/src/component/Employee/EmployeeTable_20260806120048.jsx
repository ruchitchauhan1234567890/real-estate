                                ...
                                return (
                                    <tr className="">
                                        ...
                                        <td className="border flex justify-center gap-4 py-1">
                                            <MdDeleteOutline onClick={() => handleDelete(curr.id)} className="w-5  rounded h-6 bg-gray-300 hover:bg-gray-400 " />
                                            <HiPencilSquare onClick={() => handleUpdate(curr)} className="w-5  rounded  h-6 bg-gray-300 hover:bg-gray-400" />
                                        </td>
                                    </tr>
                                )
                        })}
