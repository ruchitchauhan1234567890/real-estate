...
const EmployeeTable = () => {
    ...
    const {data,setData,setEditedEmp,open,setOpen} = useContext(EmployeeContext)
        ...
        <>
            <div>
                <form className="flex gap-2 mt-2">
                    ...
                    <div>
                        <button className="h-full cursor-pointer rounded px-1 bg-gray-300 hover:bg-gray-400" onClick={handleReset}>Reset Filter</button>
                    </div>
                </form>
            </div>
                                ...
                                return (
                                    <tr className="">
                                        ...
                                        <td className="border flex justify-center gap-4 py-1">
                                            <MdDeleteOutline onClick={() => handleDelete(curr.id)} className="w-5 cursor-pointer  rounded h-6 bg-gray-300 hover:bg-gray-400 " />
                                            <HiPencilSquare onClick={() => handleUpdate(curr)} className="w-5 cursor-pointer  rounded  h-6 bg-gray-300 hover:bg-gray-400" />
                                        </td>
                                    </tr>
                                )
                        })}
            ...
            <DeleteEmployee setDeleteModelOpen={setDeleteModelOpen} deleteModelOpen={deleteModelOpen} deletedEmp={deletedEmp} setDeletedEmp={setDeletedEmp}  />
        </>
    )
}
